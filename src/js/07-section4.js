...
var tweenSection4 = new TimelineMax()
    .add([
        ...
        TweenMax.to(".section_four>.content .section_mainImage>img", 1, { left: '15%', bottom: "-10%" }),
        TweenMax.to(".section_four>.content .section_bcgImage_1", 1, { left: '70%' }),
        TweenMax.to(".section_four>.content .section_title", 1, { left: '60%' }),
        TweenMax.to(".section_four>.content .section_text", 1, { left: '55%' })
    ]);
